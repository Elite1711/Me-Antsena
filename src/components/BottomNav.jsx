...
export default function BottomNav() {
  ...
  return <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-black/5 bg-white/95 px-2 py-2 backdrop-blur-xl dark:border-white/10 dark:bg-[#17110A]/95 md:hidden">
