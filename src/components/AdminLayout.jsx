import { BarChart3, Boxes, LogOut, Menu, Moon, Package, ShieldCheck, Sun, Users, X } from "lucide-react";
...
export default function AdminLayout() {
  ...
  return <div className="min-h-screen bg-[#FBF6EF] dark:bg-[#17110A]">
    <aside className={`fixed inset-y-0 left-0 z-50 w-72 border-r border-black/5 bg-white p-5 transition-transform dark:border-white/10 dark:bg-[#2A1D12] ${open ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>
